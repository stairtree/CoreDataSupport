//
//  NSPersistentStoreCoordinator+Copy.swift
//  LiftOffModel
//
//  Created by Thomas Krajacic on 30.3.2018.
//  Courtesy of Ole Begemann
//  See https://oleb.net/blog/2018/03/core-data-sqlite-backup/
//
...
extension NSPersistentStoreCoordinator {
    public func backupPersistentStore(atIndex index: Int) throws -> TemporaryFile {
        ...
        func makeFilename() -> String {
            ...
            let dateString = isoDateString(withDate: Date())
...
// Shim for macOS < 10.12
private func isoDateString(withDate date: Date) -> String {
